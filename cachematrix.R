...
## Checks if a solution to the input matrix exists.  If it does, it returns the cached values
## Otherwise, runs solve function to generate inverse matrix.
cacheSolve <- function(x, ...) {
        ## Return a matrix that is the inverse of 'x'
		s <- x$getinverse()
		if(!is.null(s)) {			#cached solution exists, print message...
			message("getting cached data")
			return(s)			#return cached value and breaks out of function call
		}
